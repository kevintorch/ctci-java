...
public class AssortedMethods {
    ...
    public static String getLongTextBlob() {
        String book = "As they rounded a bend in the path that ran beside the river, Lara recognized the silhouette " +
                "of a fig tree atop a nearby hill. The weather was hot and the days were long. The fig tree was in " +
                ...
                "silhouette like a man�s face, a marshy spot beside the river where the waterfowl were easily " +
                "startled, a tall tree that looked like a man with his arms upraised. They were drawing near to the " +
                "place where there was an island in the river. The island was a good spot to make camp. They would " +
                "sleep on the island tonight."
                + "Lara had been back and forth along the river path many times in her short life. Her people had not" +
                " created the path�it had always been there, like the river�but their deerskin-shod feet and the " +
                "wooden wheels of their handcarts kept the path well worn. Lara�s people were salt traders, and their" +
                " livelihood took them on a continual journey. ";
